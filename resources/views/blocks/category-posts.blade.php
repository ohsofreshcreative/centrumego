    ...
    <div class="c-main">
        ...
        <div data-gsap-element="grid-layout" class="__posts-grid relative w-full">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                ...
                <div class="group relative bg-white pl-8 pr-8 py-8 radius b-shadow hover:shadow-md flex flex-col text-left h-full w-full sm:max-w-[320px]">
