...
{
    public $name = 'Problemy- Ostatnie wpisy';
    public $description = 'category-posts';
    public $slug = 'category-posts';
    public $category = 'formatting';
    public $icon = 'admin-post';
    public $keywords = ['posts', 'category', 'wpisy', 'kategoria', 'problems', 'problemy'];
    public $mode = 'edit';
    public $supports = [
        'align' => false,
        'mode' => false,
